...
def get_lists_for_yuvals_group(output_folder_path, fasta_table_path):
        ...
        for file_folder in list(paths.iterdir()):
            if file_folder.stem != '.DS_Store':
                ...
                if len(final_protein_table) == 1: 
                    ...
                    for table in final_protein_table: 
                        if "BAT" in table.stem: 
                            dict_of_df_paths[file_name] = table
